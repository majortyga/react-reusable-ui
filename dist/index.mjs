...
function Table({
  ...
  return /* @__PURE__ */ React8.createElement("div", { className: `overflow-x-auto ${className}` }, /* @__PURE__ */ React8.createElement(
    "div",
    {
      className: "relative",
      style: {
...
var Calendar = ({
  ...
  return /* @__PURE__ */ React13.createElement(
    ...
    /* @__PURE__ */ React13.createElement("div", { className: "flex items-center justify-between mb-2 gap-2" }, /* @__PURE__ */ React13.createElement("button", { onClick: () => setCurrent(new Date(year, month - 1, 1)) }, "<"), /* @__PURE__ */ React13.createElement(
      Select_default,
      {
        value: year.toString(),
    ...
    ), /* @__PURE__ */ React13.createElement("span", { className: "font-semibold" }, current.toLocaleString("default", { month: "long" })), /* @__PURE__ */ React13.createElement("button", { onClick: () => setCurrent(new Date(year, month + 1, 1)) }, ">")),
    /* @__PURE__ */ React13.createElement("div", { className: "grid grid-cols-7 gap-1 text-xs mb-1" }, ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((d) => /* @__PURE__ */ React13.createElement(
      "div",
      {
        key: d,
    ...
    /* @__PURE__ */ React13.createElement("div", { className: "grid grid-cols-7 gap-1" }, Array.from({ length: firstDay }).map((_, i) => /* @__PURE__ */ React13.createElement("div", { key: i })), Array.from({ length: days }, (_, i) => {
      const day = i + 1;
      ...
      return renderDay ? renderDay(date, isSelected, isToday, disabled) : /* @__PURE__ */ React13.createElement(
        "button",
        {
          key: day,
    ...
    showTimePicker && (timePickerInline || showTime) && /* @__PURE__ */ React13.createElement("div", { className: "mt-4 flex flex-col gap-2 items-center" }, /* @__PURE__ */ React13.createElement("div", { className: "flex gap-2 items-center" }, /* @__PURE__ */ React13.createElement(
      Select_default,
      {
        popupPosition: "top",
    ...
    ), showSeconds && /* @__PURE__ */ React13.createElement(React13.Fragment, null, ":", /* @__PURE__ */ React13.createElement(
      Select_default,
      {
        popupPosition: "top",
...
var Rating = ({
  ...
  return /* @__PURE__ */ React19.createElement("div", { className: `flex items-center gap-1 ${className}` }, Array.from({ length: max }, (_, i) => {
